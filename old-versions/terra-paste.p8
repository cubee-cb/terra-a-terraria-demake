...
if stat(120) or p then
 ...
 if mode==2 then
  ...
  if p then
   for i=0,32767 do
    poke(0x8000+i,ord(sub(p,i+1,_))-32)
   end
  -- from drop
  else
...
-- random tree tick
tx,ty=rnd(256),rnd(47)
if(mget(tx,ty)==27)tree(tx,ty+1)

bossmusic,invside,craftsel,frc=false,1,1,pair and 0.03 or 0.08
   ...
   if til~=0 and((hitype=="axe" and tile==83) or (hitype=="pick" and fget(tile,1) and bget(actx,acty-1)~=83))then
    ...
    pdigt+=1
	    ...
	    -- everything else
		  	 ...
		  	 additem(drops[tile] or tile,px+digx,py+digy,1)
	   	 mset(actx,acty,0)
	    end
   	 ...
   	 do
   	  b=bget(actx,acty+ty)
  	   additem(drops[b] or b,px+digx,py+digy+ty*8,1)
   	  mset(actx,acty+ty,0)
  	   ty-=1
  	  end
...
for i in all(items) do
 ...
 -- fall
  ...
  if fget(bget(x/8+0.25,y/8),0) or fget(bget(x/8-0.25,y/8),0) then
   i.xv=0
  end
 end
...

