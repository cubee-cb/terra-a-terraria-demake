...
-- player alive
 ...
 if btn(0) then
  ...
  -- compact movement
  if(pxv>-1)pxv-=pxv>0 and 0.15 or 0.08
...
for i in all(mobs) do
 ...
 elseif id=="tentacle" then
  ...
  i.angv,d=mid(-0.004,i.angv,0.004),
...
function generate()
 ...
 function maketunnel()
  ...
  for ix=-s,s do
   for iy=-s,s do
	...
	worlddir,ry,ra,tunnel,dirttile=sgn(rnd()-.5)*98,30,0,0,2
 genprint"sculpting the land"
   ...
   -- dirt
    ...
    cs,js=128-worlddir,128+worlddir

	   -- put jungle
	   if ix>js-31 and ix<js+31 then
	    dirttile=7

    -- put corruption or dirt
	   else
	    dirttile=(ix>cs-31 and ix<cs+31) and 11 or 2
...
pgfx,php,php_max,inventory=tostr(plr[3] or ""),hp[1],hp[2],{}
...

